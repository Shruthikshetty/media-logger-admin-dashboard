...
export const AppColors = {
  ...
  // UI colors for surfaces, text, and borders
  ui: {
  ...
  feedback: {
    ...
    success: '#10b981', // Main success green for indicators
    error: '#ef4444', // Main error red
    warning: '#f59e0b', // Main warning amber
    info: '#3b82f6', // Main info blue, consistent with primary color
  },
